...
//       </label>
//       {children}
//       {hint && <p className="text-white text-[10px] mt-1">{hint}</p>}
//     </div>
//   );
// }
...
//   // ============================================
//   // ✅ SCROLL FIX: Lock body scroll while modal is open
//   // (Loading state mein bhi kaam karega kyunki hook top-level pe hai)
//   // ============================================
//   useEffect(() => {
...
//   return (
//     <>
//       {/* ✅ SCROLL FIX: Custom scrollbar styles (blue theme) */}
//       <style>{`
...
//           exit={{ opacity: 0, y: 10 }}
//           transition={{ duration: 0.2, ease: "easeOut" }}
//           className="relative z-10 flex flex-col h-full overflow-hidden bg-[#081730]"
//           onClick={(e) => e.stopPropagation()}
//         >
//           {/* ===== HEADER ===== */}
//           <div className="shrink-0 border-b border-white/6 bg-[#081730]">
...
//           {/* ===== SCROLLABLE CONTENT ===== */}
//           {/* ✅ SCROLL FIX: min-h-0 + will-change-transform removed + data-lenis-prevent added */}
//           <div
...
// // ✅ UPDATED PROPERTY TYPES — value backend ke enum se match karta hai
// const PROPERTY_TYPES = [
...
//       price: property.price?.toString() || "",
//       priceType: property.priceType || "sale",
//       currency: property.currency || DEFAULT_CURRENCY, // ✅ Fallback: USD
//       location: property.location || "",
//       city: property.city || "",
//       area: property.area || "",
//       address: property.address || "",
...
//       fd.append("latitude", form.latitude || "");
//       fd.append("longitude", form.longitude || "");
//       fd.append("propertyType", form.propertyType); // ✅ Already normalized (e.g. "residential-sale")
//       fd.append("propertyCode", (form.propertyCode || "").trim());
//       fd.append("bedrooms", String(form.bedrooms || 0));
//       fd.append("bathrooms", String(form.bathrooms || 0));
//       fd.append("kitchens", String(form.kitchens || 0));
...
//   // ✅ Legacy type fallback — purani property agar old type ki hai
//   // (e.g. "house") to dropdown mein dikhengi "(old)" mark ke sath,
//   // taake user dekh sake aur naye type mein change kar sake
//   const isLegacyType = form.propertyType && !PROPERTY_TYPES.some((t) => t.value === form.propertyType);
...
//                     label="Property Type"
//                     required
//                     hint={isLegacyType ? "Current type is outdated — please select a new type" : undefined}
//                   >
//                     <select
//                       value={form.propertyType}
//                       onChange={(e) => handleChange("propertyType", e.target.value)}
//                       className={`${selectClass} ${isLegacyType ? "border-amber-500/40" : ""}`}
//                     >
//                       <option value="" style={optionStyle}>Select type...</option>
...
//                       {/* ✅ LEGACY FALLBACK — purana type ho to dikhao */}
//                       {isLegacyType && (
//                         <option value={form.propertyType} style={optionStyle}>
//                           {form.propertyType} (old)
//                         </option>
//                       )}
//                     </select>
//                   </Field>
...
//                     </select>
//                   </Field>
//                   <Field label="Currency" hint="USD is the only accepted currency">
//                     <select
//                       value={form.currency}
//                       onChange={(e) => handleChange("currency", e.target.value)}
//                       className={selectClass}
...
export default function PropertyUpdateForm({ property, onClose, onSuccess }) {
  ...
  // ✅ FIX 1: Portal mount check (SSR safe — client pe hi render karo)
  ...
  // ============================================
  // ✅ FIX 1: Portal — client side pe mount hone ka intezar
  // ============================================
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      price: property.price?.toString() || "",
      priceType: property.priceType || "sale",
      currency: property.currency || DEFAULT_CURRENCY,
      location: property.location || "",
      city: property.city || "",
      area: property.area || "",
      address: property.address || "",
  ...
  // ✅ Modal ka poora JSX ek variable mein — phir portal se render karenge
  const modalContent = (
    <>
      {/* Custom scrollbar + dynamic viewport height styles */}
      <style>{`
        .property-form-scroll {
          scrollbar-width: thin;
          scrollbar-color: rgba(43, 127, 255, 0.35) transparent;
        ...
        /* ✅ FIX: dynamic viewport height (mobile URL bar handle karta hai) */
        .modal-full-height {
          height: 100vh;
          height: 100dvh;
        }
      ...
      <motion.div
        ...
        onClick={onClose}
      >
        {/* ✅ FIX: modal-full-height class + flex column layout
        ...
        >
          ...
          {/* ===== SCROLLABLE CONTENT (sirf yeh scroll hota hai) ===== */}
          <div
            className="property-form-scroll flex-1 min-h-0 overflow-y-auto overscroll-contain"
            data-lenis-prevent
          >
            ...
            <div className="flex items-center justify-between px-6 lg:px-8 h-16 max-w-6xl mx-auto">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
                ...
                <button
                  ...
                  form="propertyUpdateForm"
                  disabled={saving}
                  className="px-6 py-2.5 bg-[#2B7FFF] text-white text-sm font-semibold rounded-xl hover:bg-[#2560e6] disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-2 transition-colors shrink-0"
                >
  ...
  // koi bhi transformed/filtered parent element iski fixed positioning nahi tod sakta
